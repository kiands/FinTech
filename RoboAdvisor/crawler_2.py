...
class PTTCrawler():
    ...
    search_endpoint_url = 'https://www.ptt.cc/bbs/stock/search'
    ...
    def __init__(self):
        ...
        self.next_url = PTTCrawler.search_endpoint_url
        self.total_pages = 0
    ...
    def count_pages(self):
        ...
        # print("prev_page_counter", prev_page_counter)
        # self.total_pages = int(prev_page_counter[0]) + 1
        self.total_pages += 1

    def get_posts_list(self, url):

        response = requests.get(url, params={'q': '外資'})
